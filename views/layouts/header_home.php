            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="?">Trang chủ</a>   <!--http://localhost/private/BTTH02/MVC/?controller=HomeController&action=index     ==> quay lại trang chủ-->
                        </li>
                        <li class="nav-item">

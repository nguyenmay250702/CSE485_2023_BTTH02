...
<main class="container">
    <form action="" method="post"
        ...
        <h3 style="margin-bottom: 30px">
            <?php 
            if (!isset($_GET['list_id'])) echo "Bạn có chắc muốn xóa tác giả này không"; 
            else echo "Bạn cần xóa các bài biết có mã là: ".$_GET['list_id']." trước khi xóa tác giả có mã = ".$_GET['id']; 
            ?>
        </h3>
        <div>
